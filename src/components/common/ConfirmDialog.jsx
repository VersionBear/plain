...
function ConfirmDialog({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-ink/40 px-4 backdrop-blur-sm">
      <div
        ref={dialogRef}
        role="dialog"
        aria-modal="true"
        ...
        tabIndex={-1}
        className="w-full max-w-md rounded-3xl border border-line bg-panel p-6 shadow-2xl"
      >
